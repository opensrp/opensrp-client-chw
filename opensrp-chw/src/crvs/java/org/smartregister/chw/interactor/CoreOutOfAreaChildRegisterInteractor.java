...
public class CoreOutOfAreaChildRegisterInteractor extends ClientProcessorForJava implements CoreOutOfAreaChildRegisterContract.Interactor {
    ...
    public CoreOutOfAreaChildRegisterInteractor(Context context) {
        super(context);
        new AppExecutors();
    }
    ...
    @Override
    public void getNextUniqueId(final Triple<String, String, String> triple, final CoreOutOfAreaChildRegisterContract.InteractorCallBack callBack, final String familyId) {
    ...
    @Override
    public void saveRegistration(final Pair<Client, Event> pair, final String jsonString, final boolean isEditMode, final CoreOutOfAreaChildRegisterContract.InteractorCallBack callBack) {
