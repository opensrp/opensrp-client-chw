...
import org.smartregister.chw.model.CoreOutOfAreaChildRegisterModel;
...
public class OutOfAreaChildActivity extends BaseRegisterActivity implements CoreOutOfAreaChildRegisterContract.View {
    ...
    protected void initializePresenter() {
        presenter = new CoreOutOfAreaChildRegisterPresenter(this, new CoreOutOfAreaChildRegisterModel());
    }
    ...
    protected void onResumption() {
        ...
        if (menu != null) {
            menu.getNavigationAdapter().setSelectedView(CoreConstants.DrawerMenu.OUT_OF_AREA_CHILD);
        }
    }
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof OutOfAreaFragment) {
...
//            process the form
    ...
    @Override
    public CoreOutOfAreaChildRegisterContract.Presenter presenter() {
        return (CoreOutOfAreaChildRegisterContract.Presenter) presenter;
    }
