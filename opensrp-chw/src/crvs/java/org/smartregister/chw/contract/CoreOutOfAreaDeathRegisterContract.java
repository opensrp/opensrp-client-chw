...
public interface CoreOutOfAreaDeathRegisterContract {

    interface View extends BaseRegisterContract.View {
        CoreOutOfAreaDeathRegisterContract.Presenter presenter();
    ...
    interface Presenter extends BaseRegisterContract.Presenter {
        ...
        void saveOutOfAreaDeathForm(String jsonString, boolean isEditMode);
    ...
    interface Interactor {
        ...
        void getNextUniqueId(Triple<String, String, String> triple, CoreOutOfAreaDeathRegisterContract.InteractorCallBack callBack, String familyID);

        void saveRegistration(final Pair<Client, Event> pair, final String jsonString, final boolean isEditMode, final CoreOutOfAreaDeathRegisterContract.InteractorCallBack callBack);
