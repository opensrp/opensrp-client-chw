...
public class OutOfAreaDeathAsyncTask extends AsyncTask<Void, Void, Void> {
    ...
    public OutOfAreaDeathAsyncTask(Context context, CommonRepository commonRepository, RegisterViewHolder viewHolder, CommonPersonObjectClient baseEntityId, View.OnClickListener onClickListener) {
