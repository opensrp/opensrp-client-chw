...
public class CoreDeadClientsFragment extends BaseChwRegisterFragment implements CoreChildRegisterFragmentContract.View {
    ...
    public void initializeAdapter(Set<org.smartregister.configurableviews.model.View> visibleColumns) {
        CoreDeadClientsProvider deathClientsProvider = new CoreDeadClientsProvider(requireActivity(), visibleColumns, registerActionHandler, paginationViewHandler);
    ...
    private String getFilters(String query, String filter) {
        ...
        switch (query) {
            case "second":
                ...
                break;
            case "fourth":
                filterQuery = "WHERE (  ec_out_of_area_death.name like '" + filter + "%' or ec_out_of_area_death.unique_id like '%" + filter + "%')";
                break;
            case "first":
            case "third":
            default:
