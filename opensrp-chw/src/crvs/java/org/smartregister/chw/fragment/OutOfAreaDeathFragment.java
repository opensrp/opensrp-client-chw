...
import org.smartregister.chw.provider.OutOfAreaDeathProvider;
...
public class OutOfAreaDeathFragment extends BaseChwRegisterFragment implements CoreChildRegisterFragmentContract.View {
    ...
    protected void initializePresenter() {
        ...
        presenter = new OutOfAreaDeathFragmentPresenter(this, new CoreOutOfAreaDeathFragmentModel(), viewConfigurationIdentifier);
    }
    ...
    protected int getToolBarTitle() {
        return R.string.out_of_area_death;
    }
