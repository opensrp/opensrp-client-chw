...
public class OutOfAreaDeathFragmentPresenter implements CoreChildRegisterFragmentContract.Presenter {
    ...
    public OutOfAreaDeathFragmentPresenter(CoreChildRegisterFragmentContract.View view, CoreOutOfAreaDeathFragmentModel model, String viewConfigurationIdentifier) {
    ...
    public void initializeQueries(String mainCondition) {
        String countSelect = model.countSelect("ec_out_of_area_death", mainCondition, CoreConstants.TABLE_NAME.FAMILY_MEMBER);
        String mainSelect = model.mainSelect("ec_out_of_area_death", CoreConstants.TABLE_NAME.FAMILY, CoreConstants.TABLE_NAME.FAMILY_MEMBER, mainCondition);

        getView().initializeQueryParams("ec_out_of_area_death", countSelect, mainSelect);
    ...
    public String getMainCondition() {
        return " " + "ec_out_of_area_death" + "." + org.smartregister.chw.anc.util.DBConstants.KEY.IS_CLOSED + " is 0 ";
    }
    ...
    public String getDefaultSortQuery() {
        return " MAX(ec_out_of_area_death.last_interacted_with , 0 DESC ";
    }
