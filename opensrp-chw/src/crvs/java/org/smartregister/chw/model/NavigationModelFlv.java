    ...
    public List<NavigationOption> getNavigationItems() {
        ...
        if (navigationOptions.size() == 0) {
            if (ChwApplication.getInstance().getContext().allSharedPreferences().getPreference(USER_TYPE).equals(CrvsConstants.USER)) {
                ...
                navigationOptions.add(new NavigationOption(R.mipmap.sidemenu_certification, R.mipmap.sidemenu_certification_active, R.string.birth_certification, Constants.DrawerMenu.BIRTH_NOTIFICATION, 0));
                navigationOptions.add(new NavigationOption(R.mipmap.sidemenu_certification, R.mipmap.sidemenu_certification_active, R.string.death_certification, Constants.DrawerMenu.DEATH_NOTIFICATION, 0));
                navigationOptions.add(new NavigationOption(R.mipmap.sidemenu_outofarea, R.mipmap.sidemenu_outofarea_active, R.string.out_of_area_registration, Constants.DrawerMenu.OUT_OF_AREA_CHILD, 0));
                navigationOptions.add(new NavigationOption(R.mipmap.sidemenu_outofarea, R.mipmap.sidemenu_outofarea_active, R.string.out_of_area_death, Constants.DrawerMenu.OUT_OF_AREA_DEATH, 0));
            } else if (ChwApplication.getInstance().getContext().allSharedPreferences().getPreference(USER_TYPE).equals(CrvsConstants.AGENT)) {
                navigationOptions.add(new NavigationOption(R.mipmap.sidemenu_certification, R.mipmap.sidemenu_certification_active, R.string.birth_certification, Constants.DrawerMenu.BIRTH_NOTIFICATION, 0));
                navigationOptions.add(new NavigationOption(R.mipmap.sidemenu_certification, R.mipmap.sidemenu_certification_active, R.string.death_certification, Constants.DrawerMenu.DEATH_NOTIFICATION, 0));
                navigationOptions.add(new NavigationOption(R.mipmap.sidemenu_outofarea, R.mipmap.sidemenu_outofarea_active, R.string.out_of_area_registration, Constants.DrawerMenu.OUT_OF_AREA_CHILD, 0));
                navigationOptions.add(new NavigationOption(R.mipmap.sidemenu_outofarea, R.mipmap.sidemenu_outofarea_active, R.string.out_of_area_death, Constants.DrawerMenu.OUT_OF_AREA_DEATH, 0));
