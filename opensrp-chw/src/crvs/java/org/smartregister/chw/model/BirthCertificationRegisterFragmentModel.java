...
public class BirthCertificationRegisterFragmentModel extends CoreCertificationRegisterFragmentModel {
    ...
    public String mainSelect(String tableName, String familyTableName, String familyMemberTableName, String mainCondition) {
        ...
        queryBuilder.selectInitiateMainTable(tableName, CrvsDBUtils.mainBirthCertificationColumns(tableName, familyTableName, familyMemberTableName));
    ...
    public String outOfAreaSelect(String mainCondition) {
        SmartRegisterQueryBuilder queryBuilder = new SmartRegisterQueryBuilder();
        queryBuilder.selectInitiateMainTable(EC_OUT_OF_AREA_CHILD, CrvsDBUtils.outOfAreaBirthCertificationMainColumns(EC_OUT_OF_AREA_CHILD));
        return queryBuilder.mainCondition(mainCondition);
    }
