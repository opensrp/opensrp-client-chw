        ...
        if (navigationOptions.size() == 0) {
            ...
            if (BuildConfig.USE_UNIFIED_REFERRAL_APPROACH && BuildConfig.BUILD_FOR_BORESHA_AFYA_SOUTH) {
                ...
                if (teamRoleIdentifier.equals("mother_champion")) {
                    ...
                    navigationOptions.addAll(Arrays.asList(op10, op11, op17, op12, op8, op15));
                } else {
                    navigationOptions.addAll(Arrays.asList(op10, op1, op11, op17, op12, op3, op5, op2, op13, op8, op15));
                }
            } else {
