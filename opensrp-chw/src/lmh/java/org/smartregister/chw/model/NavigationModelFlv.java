...
public class NavigationModelFlv extends DefaultNavigationModelFlv {
    ...
    public List<NavigationOption> getNavigationItems() {
        ...
        if (navigationOptions.size() == 0) {
            ...
            navigationOptions.add(new NavigationOption(R.drawable.ic_add_new_family_white, R.drawable.ic_add_new_family_white, R.string.menu_add_new_family, "Add New Family", -1));
            ...
            navigationOptions.add(new NavigationOption(R.drawable.ic_reports, R.drawable.ic_reports, R.string.reports, "Reports", -1));
        }
