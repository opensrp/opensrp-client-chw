...
public class PncMedicalHistoryActivityFlv extends DefaultPncMedicalHistoryActivityFlv {
    ...
    private LinearLayout linearLayoutPncFamilyPlanning;
    private LinearLayout linearLayoutPncFamilyPlanningDetails;

    private LinearLayout linearLayoutPncChildVaccine;
    private LinearLayout linearLayoutPncChildVaccineDetails;

    private LinearLayout linearLayoutPncImmunization;
    private LinearLayout linearLayoutPncImmunizationDetails;

    private LinearLayout linearLayoutPncGrowthAndNutrition;
    private LinearLayout linearLayoutPncGrowthAndNutritionDetails;
    ...
    public void processViewData(List<Visit> visits, Context context) {
        ...
        Map<String, Map<String, String>> hf_visit = new HashMap<>();
        ...
        // render views
        processHealthFacilityVisit(hf_visit, context);
    ...
    protected void processHealthFacilityVisit(Map<String, Map<String, String>> hf_visits, Context context) {
        if (hf_visits != null && hf_visits.size() > 0) {
            linearLayoutHealthFacilityVisit.setVisibility(View.VISIBLE);

            for (Map.Entry<String, Map<String, String>> entry : hf_visits.entrySet()) {
    ...
    private void processFamilyPlanning(Map<String, String> family_plnning, Context context) {
    ...
    private void processVaccineCard(String received, Context context) {
        if (received != null) {
    ...
    private void processImmunization(Map<String, String> immunization, Context context) {
    ...
    private void processGrowthAndNutrition(Map<String, String> growth_data, Context context) {
