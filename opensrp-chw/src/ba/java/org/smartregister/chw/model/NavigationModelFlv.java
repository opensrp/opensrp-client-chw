...
public class NavigationModelFlv implements NavigationModel.Flavor {
    ...
    public List<NavigationOption> getNavigationItems() {
        ...
        if (navigationOptions.size() == 0) {
            ...
            NavigationOption op10 = new NavigationOption(R.mipmap.sidemenu_hiv, R.mipmap.sidemenu_hiv_active, R.string.menu_hiv_clients, CoreConstants.DrawerMenu.HIV_CLIENTS, 0);
            NavigationOption op11 = new NavigationOption(R.mipmap.sidemenu_tb, R.mipmap.sidemenu_tb_active, R.string.menu_tb_clients, CoreConstants.DrawerMenu.TB_CLIENTS, 0);
            ...
            if (BuildConfig.USE_UNIFIED_REFERRAL_APPROACH) {
                navigationOptions.add(op10);
                navigationOptions.add(op11);
