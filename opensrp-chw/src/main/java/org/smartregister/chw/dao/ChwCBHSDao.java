...
public class ChwCBHSDao extends AbstractDao {
    ...
    public static Date getNextVisitDate(String baseEntityId) {
        String sql = "Select next_appointment_date from ec_cbhs_followup where entity_id = '" + baseEntityId + "' AND next_appointment_date is not null ORDER BY last_interacted_with DESC LIMIT 1";
