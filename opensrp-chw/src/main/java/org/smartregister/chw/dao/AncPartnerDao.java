...
public class AncPartnerDao extends AbstractDao {
    ...
    public static boolean isPartnerRegistered(String formSubmissionId) {
    ...
    public static boolean hasPartnerAgreeForRegistration(String formSubmissionId){
    ...
    public static boolean wasClientFound(String formSubmissionId){
