...
////////////////////////////////////////////////////////////////
    ...
    private class UpdateAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            ancWomanCount = ChwApplication.ancRegisterRepository().getAncWomenCount(familyBaseEntityId, CoreConstants.TABLE_NAME.ANC_MEMBER);
            pncWomanCount = ChwApplication.ancRegisterRepository().getAncWomenCount(familyBaseEntityId, CoreConstants.TABLE_NAME.PNC_MEMBER);
