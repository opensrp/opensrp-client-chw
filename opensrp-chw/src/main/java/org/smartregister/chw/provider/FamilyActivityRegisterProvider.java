...
import static org.smartregister.chw.util.Utils.getDateTimeFromTimeStamp;
...
public class FamilyActivityRegisterProvider extends org.smartregister.family.provider.FamilyActivityRegisterProvider {
    ...
    protected void populatePatientColumn(CommonPersonObjectClient pc, SmartRegisterClient client, final RegisterViewHolder viewHolder) {
        ...
        if (notVisited) {
            ...
            fillValue(viewHolder.lastVisit, String.format(context.getString(R.string.profile_activity_not_visited), getDateTimeFromTimeStamp(eventDate, "dd MMM yyyy")));
        } else {
            viewHolder.status.setImageResource(Utils.getActivityProfileImageResourceVistedIDentifier());
            fillValue(viewHolder.lastVisit, String.format(context.getString(R.string.profile_activity_completed), getDateTimeFromTimeStamp(eventDate, "dd MMM yyyy")));
        }
