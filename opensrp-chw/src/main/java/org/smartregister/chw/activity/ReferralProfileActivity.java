...
import org.smartregister.chw.core.interactor.CoreReferralProfileInteractor;
...
import static org.smartregister.chw.core.utils.Utils.referralToAncMember;

public class ReferralProfileActivity extends BaseReferralProfileActivity implements FamilyOtherMemberProfileExtendedContract.View, FamilyProfileExtendedContract.PresenterCallBack {
    private static final String CLIENT = "client";

    public static void startReferralProfileActivity(Activity activity, MemberObject memberObject, CommonPersonObjectClient client) {
        Intent intent = new Intent(activity, ReferralProfileActivity.class);
    ...
    protected void initializePresenter() {
        ...
        profilePresenter = new BaseReferralProfilePresenter(this, new CoreReferralProfileInteractor(), memberObject);
        fetchProfileData();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_registration:
                startFormForEdit(R.string.registration_info, org.smartregister.chw.util.Constants.JSON_FORM.FAMILY_MEMBER_REGISTER);
                return true;

            case R.id.action_remove_member:
                IndividualProfileRemoveActivity.startIndividualProfileActivity(ReferralProfileActivity.this, getClientDetailsByBaseEntityID(memberObject.getBaseEntityId()), memberObject.getFamilyBaseEntityId(), memberObject.getFamilyHead(), memberObject.getPrimaryCareGiver(), MalariaRegisterActivity.class.getCanonicalName());
                return true;
            default:
                break;
        }
    ...
    public void openMedicalHistory() {
        PncMedicalHistoryActivity.startMe(this, referralToAncMember(memberObject));
    }
    ...
    public void openReferralHistory() {
        ReferralHistoryActivity.startReferralHistoryActivity(this, memberObject);
    }
}
