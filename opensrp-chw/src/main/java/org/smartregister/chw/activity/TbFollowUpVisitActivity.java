...
public class TbFollowUpVisitActivity extends BaseTbFollowUpVisitActivity {

    public static void startMe(Activity activity, TbMemberObject memberObject, Boolean isEditMode) {
        Intent intent = new Intent(activity, TbFollowUpVisitActivity.class);
        intent.putExtra(org.smartregister.chw.anc.util.Constants.ANC_MEMBER_OBJECTS.MEMBER_PROFILE_OBJECT, TbUtil.toMember(memberObject));
    ...
    public void onBackPressed() {
        displayExitDialog(TbFollowUpVisitActivity.this::finish);
