...
public class AgywMedicalHistoryInteractor extends CoreBaseAncMedicalHistoryInteractor {
    ...
    public void getMemberHistory(final String memberID, final Context context, final BaseAncMedicalHistoryContract.InteractorCallBack callBack) {
        final Runnable runnable = () -> {
            ...
            String[] eventTypes = new String[]{Constants.Events.AGYW_BIO_MEDICAL_SERVICES, Constants.Events.AGYW_BEHAVIORAL_SERVICES, Constants.Events.AGYW_STRUCTURAL_SERVICES};
