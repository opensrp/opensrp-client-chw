...
public class JobAidsGuideBooksFragment1 extends Fragment {
    ...
    private ConstraintLayout layoutTutorials;
    private ConstraintLayout layoutCounseling;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        layoutTutorials = rootView.findViewById(R.id.layoutTutorials);
        layoutCounseling = rootView.findViewById(R.id.layoutCounseling);
