...
import org.smartregister.chw.reporting.ReportingUtil;
...
public class ChildReportingModule implements ReportingModule {
    ...
    public void generateReport(ViewGroup mainLayout) {
        ...
        mainLayout.addView(createView(new PieChartIndicatorView(mainLayout.getContext(), ReportingUtil.getPieChartViewModel(indicator4_1, indicator4_2))));
        ...
        mainLayout.addView(createView(new PieChartIndicatorView(mainLayout.getContext(), ReportingUtil.getPieChartViewModel(indicator5_1, indicator5_2))));
        ...
        mainLayout.addView(createView(new PieChartIndicatorView(mainLayout.getContext(), ReportingUtil.getPieChartViewModel(indicator6_1, indicator6_2))));
        ...
        mainLayout.addView(createView(new PieChartIndicatorView(mainLayout.getContext(), ReportingUtil.getPieChartViewModel(indicator7_1, indicator7_2))));
        ...
        mainLayout.addView(createView(new PieChartIndicatorView(mainLayout.getContext(), ReportingUtil.getPieChartViewModel(indicator8_1, indicator8_2))));
        ...
        mainLayout.addView(createView(new PieChartIndicatorView(mainLayout.getContext(), ReportingUtil.getPieChartViewModel(indicator9_1, indicator9_2))));
