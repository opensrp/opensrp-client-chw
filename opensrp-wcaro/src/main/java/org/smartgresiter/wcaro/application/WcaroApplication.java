...
import org.smartgresiter.wcaro.activity.CustomJsonFromActivity;
...
public class WcaroApplication extends DrishtiApplication {
    ...
    private FamilyMetadata getMetadata() {
        FamilyMetadata metadata = new FamilyMetadata(FamilyWizardFormActivity.class, CustomJsonFromActivity.class, FamilyProfileActivity.class, false);
