...
public class WcaroApplication extends DrishtiApplication {
    ...
    private static String[] getFtsSortFields(String tableName) {
        if (tableName.equals(Constants.TABLE_NAME.FAMILY)) {
            ...
            return new String[]{DBConstants.KEY.DOB, DBConstants.KEY.DOD, ChildDBConstants.KEY.LAST_HOME_VISIT, ChildDBConstants.KEY.VISIT_NOT_DONE, ChildDBConstants.KEY.ENTITY_TYPE, DBConstants.KEY
