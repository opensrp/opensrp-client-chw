...
public class WcaroDueRegisterProvider extends FamilyDueRegisterProvider {
    private static final String TAG = WcaroDueRegisterProvider.class.getCanonicalName();

    private final Context context;

    private final View.OnClickListener onClickListener;

    public WcaroDueRegisterProvider(Context context, CommonRepository commonRepository, Set visibleColumns, View.OnClickListener onClickListener, View.OnClickListener paginationClickListener) {
