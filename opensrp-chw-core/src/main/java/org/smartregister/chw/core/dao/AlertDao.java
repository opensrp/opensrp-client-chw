...
public class AlertDao extends AbstractDao {
    ...
    private static DataMap<Alert> alertDataMap = c -> new Alert(
            ...
            from(getCursorValue(c,AlertRepository.ALERTS_STATUS_COLUMN)),
    ...
    public static List<Alert> getActiveAlerts(String baseEntityID) {
        ...
        return AbstractDao.readData(sql, alertDataMap);
    }
