...
import com.opensrp.chw.core.adapter.ImmunizationAdapter;
...
public class ImmunizationView extends LinearLayout implements ImmunizationContact.View {
    ...
    private CoreChildHomeVisitFragment coreChildHomeVisitFragment;
    ...
    public void allDataLoaded() {
        ...
        coreChildHomeVisitFragment.allVaccineDataLoaded = true;
        if (isEditMode) {
            coreChildHomeVisitFragment.forcfullyProgressBarInvisible();
        } else {
            coreChildHomeVisitFragment.progressBarInvisible();
        }
    }
    ...
    public void updateAdapter(int position) {
        ...
        if (isEditMode) {
            coreChildHomeVisitFragment.allVaccineDataLoaded = true;
            coreChildHomeVisitFragment.submitButtonEnableDisable(true);
        }
        if (adapter == null) {
