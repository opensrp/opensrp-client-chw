...
public class MemberDueRegisterProvider extends FamilyDueRegisterProvider {
    private static final String TAG = MemberDueRegisterProvider.class.getCanonicalName();

    private final Context context;

    private final View.OnClickListener onClickListener;

    public MemberDueRegisterProvider(Context context, CommonRepository commonRepository, Set visibleColumns, View.OnClickListener onClickListener, View.OnClickListener paginationClickListener) {
